...
//        JsonObject jsonObject = new Gson().fromJson(farmerDo.toString(), JsonObject.class);
        //jsonObject = new Gson().fromJson(gsjonString, JSONObject.class);
        //jsonObject.getAsJsonObject(farmerDo);
        return repository.InsertFarmer(jsonObject);
    }
