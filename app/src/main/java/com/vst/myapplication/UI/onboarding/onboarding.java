...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
        ...
        mList.add(new ScreenItem("Add Farmers / Customers","We conduct rigorous quality testing to ensure that the milk we deliver is of the highest quality. Our team of experts conducts 26 tests every day to ensure that the milk is pure, fresh, and meets the highest standards of quality.",R.drawable.img1));
        mList.add(new ScreenItem("Collect / Sale Milk","We offer hassle-free doorstep delivery of fresh milk every day, providing you with added convenience and ensuring that you never run out of milk.",R.drawable.img2));
        mList.add(new ScreenItem("Easy Managing Reports","We offer personalized subscription plans that are tailored to your individual needs. With our flexible plans, you can easily manage your milk delivery schedule and customize your orders to ensure that you always have fresh milk on hand. Our user-friendly mobile app makes it easy to adjust your subscription plan, skip deliveries, or make any necessary changes to your order.",R.drawable.img3));
